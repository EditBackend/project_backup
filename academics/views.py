...
#
# from .models.lesson import OnlineLesson,Attendance
#
# from .models import (
#     Student, StudentPricing, StudentBalances, LeaveReason, StudentGroupLeaves,
#     StudentFreezes, StudentBalanceHistory,
#     Room, Course, Group, GroupTeacher,
#     LessonTime, LessonSchedule, Exams, ExamResults,
#     TeacherSalaryRules, TeacherSalaryPayments, TeacherSalaryCalculations,StudentTransaction
# )
...
#     from .serializers.lesson import AttendenceSerializer
#     group = get_object_or_404(Group, pk=group_pk)
#
#     if request.method == 'GET':
#         date_q      = request.query_params.get('date')
#         attendances = Attendance.objects.filter(student_group__group=group)
#         if date_q:
#             attendances = attendances.filter(lesson_date=date_q)
#         return Response({'success': True, 'data': AttendenceSerializer(attendances, many=True).data})
#
...
#     from academics.serializers import StudentListSerializer
#     group         = get_object_or_404(Group, pk=group_pk)
#     status_filter = request.query_params.get('status')
#     search        = request.query_params.get('search')
#
