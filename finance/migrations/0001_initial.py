        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "recipient",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="Oluvchi"
                    ),
                ),
                (
                    "payment_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="workly_attendance",
                        to="accounts.employee",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "call_type",
                    models.CharField(
                        choices=[("incoming", "Kiruvchi"), ("outgoing", "Chiquvchi")],
                        max_length=20,
                    ),
                ),
                (
                    ...
                    models.FileField(
                        blank=True,
                        null=True,
                        upload_to=finance.models.call_recording_upload_path,
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["-call_time"], name="finance_cal_call_ti_161006_idx"
                    ),
                    models.Index(
                        fields=["call_type"], name="finance_cal_call_ty_06829c_idx"
                    ),
                    models.Index(
                        fields=["status"], name="finance_cal_status_05d930_idx"
                    ),
                ],
            },
        ),
